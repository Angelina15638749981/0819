...
class WeChat():
    ...
    ##获取uuid
    def getUuid(self):
        url="https://login.wx.qq.com/jslogin?appid=wx782c26e4c19acffb&redirect_uri=https%3A%2F%2Fwx.qq.com%2Fcgi-bin%2Fmmwebwx-bin%2Fwebwxnewloginpage&fun=new&lang=zh_CN&_=1520933268366"
    ...
    ##扫码之后是200
    def login(self):
        url="https://login.wx.qq.com/cgi-bin/mmwebwx-bin/login?loginicon=true&uuid={}&tip=0&r=-527204269&_=1520945398715".format(self.uuid)
        while True:
            response=self.session.get(url)
