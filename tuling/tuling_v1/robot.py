...
# KEY='e4c59585ded1480b87c10b753e7baae7'
#
KEY = '62a98648325a4eea9407945a275ea29c'
...
def get_response(msg):
    ...
    data = {
        ...
        'userid': 'wechat-robot-test',  # 这里你想改什么都可以
...
def text_reply(msg):
    ...
    # if msg.User["NickName"] == '大联盟' or msg.User["NickName"] == '武汉交易群':
        ...
        for i in receive_msg:
            ...
            try:
                ...
                for word in words:
                    print(word, len(word))
                    if len(numbers) != 0 and len(word) < 8:
...
if __name__ == '__main__':
    itchat.auto_login()  # , 保持在线，下次运行代码可自动登录  hotReload=True
    itchat.run()
